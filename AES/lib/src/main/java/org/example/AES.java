...
public class AES {
    ...
    static List<String> codes = List.of("20231678001", "20231678002", "20231678003");
    ...
    public static void main(String args[]) throws IOException 
    {
        ...
        try 
        {
            ...
            System.out.println("polynomial to use: " + Polynomial.getIrreduciblePolynomial(Polynomial.calculateAESModulo(codes)));
